...
const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col md:flex-row relative items-center snap-start h-screen md:gap-100 gap-10 px-4"
    >
      {/* Profile Image Container */}
      <div className="bg-white/10 backdrop-blur-2xl md:ml-8 p-4 rounded-full shadow-md border border-white/20">
        <img
          src="/prince.PNG"
          alt="..."
          className="rounded-full w-[300px] h-[300px] md:w-[520px] md:h-[520px] object-[80%_20%] object-cover"
        />
      </div>
      ...
      <div className="flex justify-center gap-6 md:gap-20 mt-6 md:ml-27 md:absolute md:bottom-30">
        ...
        <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer">
          <FaLinkedin className="text-3xl md:text-4xl text-blue-600 hover:text-blue-800 transition" />
        </a>
        <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer">
          <FaInstagram className="text-3xl md:text-4xl text-blue-400 hover:text-blue-600 transition" />
        </a>
        <a href="mailto:your@email.com">
          <FaEnvelope className="text-3xl md:text-4xl text-red-500 hover:text-red-600 transition" />
        </a>
      </div>

      {/* Text Info */}
      <div className="info flex flex-col gap-6 md:gap-10 mt-6 md:mt-0 md:w-150">
        <h1 className="text-4xl md:text-7xl text-center md:text-left">
          a little bit <br /> about me
        </h1>
        <p className="text-base md:text-xl text-justify md:text-left">
